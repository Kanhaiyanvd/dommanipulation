...
function submitDetails(e) {
  ...
  if (!expense.value || !descr.value || !catag.value || catag.value=="choose a catagory") {
    ...
    axios.post("https://crudcrud.com/api/4dd2060115ce4df28bda4c12b062f10a/expensedata", myObj)
...
window.addEventListener('DOMContentLoaded', () => {
  axios.get("https://crudcrud.com/api/4dd2060115ce4df28bda4c12b062f10a/expensedata")
    .then(function (response) {
...
function addNewlineElement(myObj) {
  ...
  function deleteEle(e) {
    ...
    axios.delete(`https://crudcrud.com/api/4dd2060115ce4df28bda4c12b062f10a/expensedata/${parseObj._id}`)
      .then(function (response) {
        console.log(response);
      })
      .catch(function (error) {
